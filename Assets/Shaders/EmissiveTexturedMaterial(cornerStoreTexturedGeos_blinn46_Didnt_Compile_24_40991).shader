Shader "Unreal/EmissiveTexturedMaterial(cornerStoreTexturedGeos_blinn46_Didnt_Compile_24_40991)"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        #include "EmissiveTexturedMaterial(cornerStoreTexturedGeos_blinn46_Didnt_Compile_24_40991).hlsl"

Shader "Unreal/MI_Leather_02_Black_Dark"
{
    Properties
    {
		...
		Material_Texture2D_1( "Leather AO", 2D ) = "white" {}
		Material_Texture2D_2( "Leather Roughness", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_Leather_02_Black_Dark.hlsl"

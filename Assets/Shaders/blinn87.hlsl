...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local6 = dot(Local3.rgb,MaterialFloat3(0.30000001,0.58999997,0.11000000));
	MaterialFloat Local7 = PositiveClampedPow(Local6,MaterialFloat3(1.00000000,1.00000000,1.00000000).x);
	...
	PixelMaterialInputs.Roughness = MaterialFloat3(0.41666701,0.41666701,0.41666701).r;

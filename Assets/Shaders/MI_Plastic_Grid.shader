Shader "Unreal/MI_Plastic_Grid"
{
    Properties
    {
		...
		Material_Texture2D_0( "Normal_Texture", 2D ) = "white" {}
		Material_Texture2D_1( "Difuse_Texture", 2D ) = "white" {}
		Material_Texture2D_2( "Metallic_Texture", 2D ) = "white" {}
		Material_Texture2D_3( "Specular_Texture", 2D ) = "white" {}
		Material_Texture2D_4( "Roughness_Texture", 2D ) = "white" {}

...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[1] = float4(4.124727,4.124727,4.124727,0.000000);//(Unknown)
	Material.PreshaderBuffer[2] = float4(4.124727,4.124727,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[3] = float4(4.124727,4.124727,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(4.124727,4.124727,1.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[5] = float4(0.000000,0.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[6] = float4(0.025000,0.025000,0.022035,1.000000);//(Unknown)
	Material.PreshaderBuffer[7] = float4(0.025000,0.025000,0.022035,0.515701);//(Unknown)
	Material.PreshaderBuffer[8] = float4(1.000000,0.958098,0.000000,0.000000);//(Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local4 = (Local2.rgb * Material.PreshaderBuffer[4].xyz);
	...
	MaterialFloat3 Local5 = lerp(MaterialFloat3(0.00000000,0.00000000,0.00000000),Material.PreshaderBuffer[5].xyz,Material.PreshaderBuffer[4].w);
	MaterialFloat2 Local6 = (DERIV_BASE_VALUE(Local0) * ((MaterialFloat2)Material.PreshaderBuffer[8].x));
	MaterialFloat Local7 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local6), 1);
	MaterialFloat4 Local8 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleBias(Material_Texture2D_1,samplerMaterial_Texture2D_1,DERIV_BASE_VALUE(Local6),View.MaterialTextureMipBias));
	MaterialFloat Local9 = MaterialStoreTexSample(Parameters, Local8, 1);
	MaterialFloat Local10 = (Local8.rgb.g * Material.PreshaderBuffer[8].y);

	PixelMaterialInputs.EmissiveColor = Local5;
	PixelMaterialInputs.Opacity = 1.00000000;
	PixelMaterialInputs.OpacityMask = 1.00000000;
	PixelMaterialInputs.BaseColor = Material.PreshaderBuffer[7].xyz;
	PixelMaterialInputs.Metallic = 0.00000000;
	PixelMaterialInputs.Specular = Material.PreshaderBuffer[7].w;
	PixelMaterialInputs.Roughness = Local10;

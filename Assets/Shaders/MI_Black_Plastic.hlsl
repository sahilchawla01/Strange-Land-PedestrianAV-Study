...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[2] = float4(0.040000,0.040000,0.040000,0.000000);//(Unknown)
	Material.PreshaderBuffer[3] = float4(1.000000,1.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(0.040000,0.040000,0.040000,0.000000);//(Unknown)
	Material.PreshaderBuffer[5] = float4(1.000000,0.388490,0.000000,0.559633);//(Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat2 Local2 = (DERIV_BASE_VALUE(Local1) * ((MaterialFloat2)Material.PreshaderBuffer[3].x));
	...
	MaterialFloat3 Local6 = (Local4.rgb * ((MaterialFloat3)Material.PreshaderBuffer[3].y));
	MaterialFloat3 Local7 = (Material.PreshaderBuffer[4].xyz * Local6);
	MaterialFloat Local8 = dot(Local7,MaterialFloat3(0.30000001,0.58999997,0.11000000));
	MaterialFloat3 Local9 = lerp(Local7,((MaterialFloat3)Local8),Material.PreshaderBuffer[4].w);
	MaterialFloat3 Local10 = PositiveClampedPow(Local9,((MaterialFloat3)Material.PreshaderBuffer[5].x));

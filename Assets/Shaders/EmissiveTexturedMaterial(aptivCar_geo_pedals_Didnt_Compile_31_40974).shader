Shader "Unreal/EmissiveTexturedMaterial(aptivCar_geo_pedals_Didnt_Compile_31_40974)"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        #include "EmissiveTexturedMaterial(aptivCar_geo_pedals_Didnt_Compile_31_40974).hlsl"

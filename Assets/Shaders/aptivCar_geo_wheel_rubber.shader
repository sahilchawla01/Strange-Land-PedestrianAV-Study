Shader "Unreal/aptivCar_geo_wheel_rubber"
{
    Properties
    {
		...
		Material_Texture2D_0( "Waymo_NAIAS_3_exterior_diffuse", 2D ) = "white" {}
		Material_Texture2D_1( "Waymo_NAIAS_3_exterior_reflection", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "aptivCar_geo_wheel_rubber.hlsl"

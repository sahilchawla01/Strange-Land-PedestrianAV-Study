...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local8 = normalize(Local6.rgb);
	MaterialFloat Local9 = dot(Local6.rgb,MaterialFloat3(0.30000001,0.58999997,0.11000000));
	MaterialFloat Local10 = PositiveClampedPow(Local9,1.29999995);
	MaterialFloat3 Local11 = (Local8 * ((MaterialFloat3)Local10));
	MaterialFloat2 Local12 = (DERIV_BASE_VALUE(Local0) * ((MaterialFloat2)3.00000000));
	MaterialFloat Local13 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local12), 0);
	MaterialFloat4 Local14 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_2,samplerMaterial_Texture2D_2,DERIV_BASE_VALUE(Local12),View.MaterialTextureMipBias));
	MaterialFloat Local15 = MaterialStoreTexSample(Parameters, Local14, 0);
	MaterialFloat Local16 = CustomExpression0(Parameters);
	...
	PixelMaterialInputs.Specular = Local14.rgb;

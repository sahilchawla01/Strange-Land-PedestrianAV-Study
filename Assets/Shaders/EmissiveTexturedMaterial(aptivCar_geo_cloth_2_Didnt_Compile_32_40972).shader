Shader "Unreal/EmissiveTexturedMaterial(aptivCar_geo_cloth_2_Didnt_Compile_32_40972)"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        #include "EmissiveTexturedMaterial(aptivCar_geo_cloth_2_Didnt_Compile_32_40972).hlsl"

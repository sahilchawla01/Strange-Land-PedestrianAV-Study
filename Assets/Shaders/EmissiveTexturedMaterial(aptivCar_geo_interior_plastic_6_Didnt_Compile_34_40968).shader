Shader "Unreal/EmissiveTexturedMaterial(aptivCar_geo_interior_plastic_6_Didnt_Compile_34_40968)"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        #include "EmissiveTexturedMaterial(aptivCar_geo_interior_plastic_6_Didnt_Compile_34_40968).hlsl"

...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[1] = float4(0.022800,0.048994,0.120000,1.000000);//(Unknown)
	Material.PreshaderBuffer[2] = float4(0.100000,0.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[3] = float4(0.022800,0.048994,0.120000,0.000000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(0.460000,0.661171,1.000000,1.000000);//(Unknown)
	Material.PreshaderBuffer[5] = float4(6.019181,0.460000,0.661171,1.000000);//(Unknown)
	Material.PreshaderBuffer[6] = float4(0.178181,0.330775,-0.926736,1.000000);//(Unknown)
	Material.PreshaderBuffer[7] = float4(0.178181,0.330775,-0.926736,0.000000);//(Unknown)
	Material.PreshaderBuffer[8] = float4(0.178181,0.330775,-0.926736,0.000300);//(Unknown)
	...
	Material.PreshaderBuffer[11] = float4(17.793625,1.000000,1.000000,1.000000);//(Unknown)
	Material.PreshaderBuffer[12] = float4(17.793625,17.793625,17.793625,0.000000);//(Unknown)
	Material.PreshaderBuffer[13] = float4(0.926932,0.943709,0.995834,1.000000);//(Unknown)
	Material.PreshaderBuffer[14] = float4(1.000000,1.000000,4.000000,1.000000);//(Unknown)
	Material.PreshaderBuffer[15] = float4(0.926932,0.943709,0.995834,0.000000);//(Unknown)

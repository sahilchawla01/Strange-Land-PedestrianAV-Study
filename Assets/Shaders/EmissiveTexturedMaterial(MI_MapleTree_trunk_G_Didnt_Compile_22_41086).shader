Shader "Unreal/EmissiveTexturedMaterial(MI_MapleTree_trunk_G_Didnt_Compile_22_41086)"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        #include "EmissiveTexturedMaterial(MI_MapleTree_trunk_G_Didnt_Compile_22_41086).hlsl"

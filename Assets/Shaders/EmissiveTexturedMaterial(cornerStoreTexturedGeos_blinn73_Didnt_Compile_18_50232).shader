Shader "Unreal/EmissiveTexturedMaterial(cornerStoreTexturedGeos_blinn73_Didnt_Compile_18_50232)"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        #include "EmissiveTexturedMaterial(cornerStoreTexturedGeos_blinn73_Didnt_Compile_18_50232).hlsl"

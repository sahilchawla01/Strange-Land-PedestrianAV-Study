Shader "Unreal/EmissiveTexturedMaterial(aptivCar_geo_interior_plastic_7_Didnt_Compile_35_40966)"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        #include "EmissiveTexturedMaterial(aptivCar_geo_interior_plastic_7_Didnt_Compile_35_40966).hlsl"

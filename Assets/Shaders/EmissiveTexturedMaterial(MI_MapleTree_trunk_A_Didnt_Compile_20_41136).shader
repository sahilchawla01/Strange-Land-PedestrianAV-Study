Shader "Unreal/EmissiveTexturedMaterial(MI_MapleTree_trunk_A_Didnt_Compile_20_41136)"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        #include "EmissiveTexturedMaterial(MI_MapleTree_trunk_A_Didnt_Compile_20_41136).hlsl"

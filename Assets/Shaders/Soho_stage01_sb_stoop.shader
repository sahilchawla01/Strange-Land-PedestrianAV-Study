Shader "Unreal/Soho_stage01_sb_stoop"
{
    Properties
    {
		...
		Material_Texture2D_0( "stoop_bmp01", 2D ) = "white" {}
		Material_Texture2D_1( "stoop_clr01", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "Soho_stage01_sb_stoop.hlsl"

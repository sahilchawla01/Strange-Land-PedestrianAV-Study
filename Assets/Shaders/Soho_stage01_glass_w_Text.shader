Shader "Unreal/Soho_stage01_glass_w_Text"
{
    Properties
    {
		...
		Material_Texture2D_0( "FloorsWallsGlass_clr01", 2D ) = "white" {}
		Material_Texture2D_1( "FloorsWallsGlass_alph01", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "Soho_stage01_glass_w_Text.hlsl"

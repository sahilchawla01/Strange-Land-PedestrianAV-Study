Shader "Unreal/Soho_stage01_sb_cornice01"
{
    Properties
    {
		...
		Material_Texture2D_0( "cornice_bmp01", 2D ) = "white" {}
		Material_Texture2D_1( "cornice_clr01", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "Soho_stage01_sb_cornice01.hlsl"

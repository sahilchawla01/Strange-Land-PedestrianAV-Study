Shader "Unreal/MI_BrakeRotor_Iron"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_DiscRotorCrack_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_RadialNoise_N", 2D ) = "white" {}
		Material_Texture2D_2( "T_DiscRotorCrack", 2D ) = "white" {}
		Material_Texture2D_3( "T_RadialNoise", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_BrakeRotor_Iron.hlsl"

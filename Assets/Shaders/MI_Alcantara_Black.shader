Shader "Unreal/MI_Alcantara_Black"
{
    Properties
    {
		...
		Material_Texture2D_0( "Fabric Normal", 2D ) = "white" {}
		Material_Texture2D_1( "Cloth Fold Normal", 2D ) = "white" {}
		Material_Texture2D_2( "Fabric Detail Normal", 2D ) = "white" {}
		Material_Texture2D_3( "Color Texture", 2D ) = "white" {}
		Material_Texture2D_4( "Roughness Texture", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_Alcantara_Black.hlsl"

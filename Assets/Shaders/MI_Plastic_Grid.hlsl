...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[1] = float4(15.000000,0.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[2] = float4(1.000000,1.000000,0.245000,0.000000);//(Unknown)
	Material.PreshaderBuffer[3] = float4(1.000000,1.000000,0.245000,0.000000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(0.000000,0.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[5] = float4(0.065000,0.065000,0.065000,0.000000);//(Unknown)
	Material.PreshaderBuffer[6] = float4(1.000000,0.065000,0.065000,0.065000);//(Unknown)
	Material.PreshaderBuffer[7] = float4(0.000000,1.000000,0.195829,0.200995);//(Unknown)
	Material.PreshaderBuffer[8] = float4(0.250216,0.000000,0.000000,0.000000);//(Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local5 = (Local3.rgb * Material.PreshaderBuffer[3].xyz);
	...
	MaterialFloat3 Local6 = lerp(MaterialFloat3(0.00000000,0.00000000,0.00000000),Material.PreshaderBuffer[4].xyz,Material.PreshaderBuffer[3].w);
	...
	MaterialFloat3 Local10 = (Local8.rgb * ((MaterialFloat3)Material.PreshaderBuffer[6].x));
	MaterialFloat3 Local11 = (Material.PreshaderBuffer[6].yzw * Local10);
	MaterialFloat Local12 = dot(Local11,MaterialFloat3(0.30000001,0.58999997,0.11000000));
	MaterialFloat3 Local13 = lerp(Local11,((MaterialFloat3)Local12),Material.PreshaderBuffer[7].x);
	MaterialFloat3 Local14 = PositiveClampedPow(Local13,((MaterialFloat3)Material.PreshaderBuffer[7].y));
	MaterialFloat4 Local15 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_2,samplerMaterial_Texture2D_2,DERIV_BASE_VALUE(Local1),View.MaterialTextureMipBias));
	MaterialFloat Local16 = MaterialStoreTexSample(Parameters, Local15, 0);
	MaterialFloat3 Local17 = (Local15.rgb * ((MaterialFloat3)Material.PreshaderBuffer[7].z));
	MaterialFloat4 Local18 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_3,samplerMaterial_Texture2D_3,DERIV_BASE_VALUE(Local1),View.MaterialTextureMipBias));
	MaterialFloat Local19 = MaterialStoreTexSample(Parameters, Local18, 0);
	MaterialFloat3 Local20 = (Local18.rgb * ((MaterialFloat3)Material.PreshaderBuffer[7].w));
	MaterialFloat4 Local21 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_4,samplerMaterial_Texture2D_4,DERIV_BASE_VALUE(Local1),View.MaterialTextureMipBias));
	MaterialFloat Local22 = MaterialStoreTexSample(Parameters, Local21, 0);
	MaterialFloat3 Local23 = (Local21.rgb * ((MaterialFloat3)Material.PreshaderBuffer[8].x));

	PixelMaterialInputs.EmissiveColor = Local6;
	PixelMaterialInputs.Opacity = 1.00000000;
	PixelMaterialInputs.OpacityMask = 1.00000000;
	PixelMaterialInputs.BaseColor = Local14;
	PixelMaterialInputs.Metallic = Local17;
	PixelMaterialInputs.Specular = Local20;

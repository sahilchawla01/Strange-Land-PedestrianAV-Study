Shader "Unreal/EmissiveTexturedMaterial(MI_MapleTree_branch_A_Didnt_Compile_19_50214)"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        #include "EmissiveTexturedMaterial(MI_MapleTree_branch_A_Didnt_Compile_19_50214).hlsl"

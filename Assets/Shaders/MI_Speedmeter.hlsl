...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[3] = float4(2.000000,2.000000,2.000000,1.000000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(2.000000,2.000000,2.000000,1.000000);//(Unknown)
	Material.PreshaderBuffer[5] = float4(0.000000,0.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[6] = float4(0.100000,0.000000,0.500000,0.000000);//(Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local4 = (Local2.rgb * Material.PreshaderBuffer[2].xyz);
	...
	MaterialFloat3 Local11 = PositiveClampedPow(Local9.rgb,((MaterialFloat3)Material.PreshaderBuffer[4].w));
	MaterialFloat3 Local12 = (Local8 * Local11);
	MaterialFloat3 Local13 = lerp(Local12,Material.PreshaderBuffer[5].yzw,Material.PreshaderBuffer[5].x);
	...
	PixelMaterialInputs.BaseColor = Local14.rgb;
	PixelMaterialInputs.Metallic = Material.PreshaderBuffer[6].x;
	PixelMaterialInputs.Specular = Material.PreshaderBuffer[6].y;
	PixelMaterialInputs.Roughness = Material.PreshaderBuffer[6].z;

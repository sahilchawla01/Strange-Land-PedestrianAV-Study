...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[1] = float4(5.000000,2.713348,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[2] = float4(0.000000,0.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[3] = float4(0.165132,0.191202,0.219526,1.000000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(0.165132,0.191202,0.219526,0.500000);//(Unknown)
	Material.PreshaderBuffer[5] = float4(0.394954,0.138257,1.800000,1.500000);//(Unknown)
	Material.PreshaderBuffer[6] = float4(-0.500000,0.550000,0.000000,0.000000);//(Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local8 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local1), 7);
	MaterialFloat4 Local9 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleBias(Material_Texture2D_1,samplerMaterial_Texture2D_1,DERIV_BASE_VALUE(Local1),View.MaterialTextureMipBias));
	MaterialFloat Local10 = MaterialStoreTexSample(Parameters, Local9, 7);
	MaterialFloat Local11 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local1), 4);
	...
	MaterialFloat Local14 = lerp(Material.PreshaderBuffer[5].y,Material.PreshaderBuffer[5].x,Local12.rgb.r);
	MaterialFloat Local15 = (Local14 * Material.PreshaderBuffer[5].z);
	MaterialFloat Local16 = (1.00000000 - Local15);
	MaterialFloat3 Local17 = (Local9.rgb * ((MaterialFloat3)Local16));
	MaterialFloat Local18 = lerp(Material.PreshaderBuffer[6].x,Material.PreshaderBuffer[5].w,Local17.x);
	MaterialFloat Local19 = saturate(Local18);
	MaterialFloat Local20 = (Local19.r * 2.00000000);
	MaterialFloat Local21 = lerp(0.34999999,Material.PreshaderBuffer[6].y,Local20);

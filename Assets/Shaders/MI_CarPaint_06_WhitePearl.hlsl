...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[5] = float4(0.078787,0.156250,0.041969,1.000000);//(Unknown)
	...
	Material.PreshaderBuffer[17] = float4(0.078787,0.156250,0.041969,0.400000);//(Unknown)
	Material.PreshaderBuffer[18] = float4(3.000000,0.400000,0.300000,0.000000);//(Unknown)

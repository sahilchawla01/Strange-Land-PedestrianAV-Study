Shader "Unreal/EmissiveTexturedMaterial(cornerStoreTexturedGeos_blinn7_Didnt_Compile_26_40987)"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        #include "EmissiveTexturedMaterial(cornerStoreTexturedGeos_blinn7_Didnt_Compile_26_40987).hlsl"

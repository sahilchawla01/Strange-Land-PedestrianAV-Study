Shader "Unreal/Soho_stage01_sb_windowsMain02"
{
    Properties
    {
		...
		Material_Texture2D_0( "windows_bmp01", 2D ) = "white" {}
		Material_Texture2D_1( "designs_clr01", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "Soho_stage01_sb_windowsMain02.hlsl"

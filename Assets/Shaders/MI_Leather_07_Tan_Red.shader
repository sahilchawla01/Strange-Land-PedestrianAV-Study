Shader "Unreal/MI_Leather_07_Tan_Red"
{
    Properties
    {
		...
		Material_Texture2D_0( "Leather Normal", 2D ) = "white" {}
		Material_Texture2D_1( "Perforated Normal", 2D ) = "white" {}
		Material_Texture2D_2( "Perforated Texture", 2D ) = "white" {}
		Material_Texture2D_3( "Leather AO", 2D ) = "white" {}
		Material_Texture2D_4( "Leather Roughness", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_Leather_07_Tan_Red.hlsl"

...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[2] = float4(1.000000,1.000000,0.201000,0.000000);//(Unknown)
	Material.PreshaderBuffer[3] = float4(1.000000,1.000000,0.201000,0.000000);//(Unknown)
	...
	Material.PreshaderBuffer[7] = float4(0.000000,0.791129,0.500000,0.100000);//(Unknown)
	Material.PreshaderBuffer[8] = float4(0.700000,0.000000,0.000000,0.000000);//(Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	PixelMaterialInputs.Metallic = Material.PreshaderBuffer[7].z;
	PixelMaterialInputs.Specular = Material.PreshaderBuffer[7].w;
	PixelMaterialInputs.Roughness = Material.PreshaderBuffer[8].x;

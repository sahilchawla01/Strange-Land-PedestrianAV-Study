Shader "Unreal/EmissiveTexturedMaterial(aptivCar_geo_grille_Didnt_Compile_29_40978)"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        #include "EmissiveTexturedMaterial(aptivCar_geo_grille_Didnt_Compile_29_40978).hlsl"

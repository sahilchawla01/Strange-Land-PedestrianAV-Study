Shader "Unreal/aptivCar_geo_brake_disk"
{
    Properties
    {
		...
		Material_Texture2D_0( "Waymo_NAIAS_3_exterior_bump", 2D ) = "white" {}
		Material_Texture2D_1( "Waymo_NAIAS_3_exterior_diffuse", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "aptivCar_geo_brake_disk.hlsl"

Shader "Unreal/MI_Reflector_orange_Translucent2"
{
    Properties
    {
		...
		Material_Texture2D_0( "Cover (Top Layer) Normal", 2D ) = "white" {}
		Material_Texture2D_1( "T_PlasticDirt", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_Reflector_orange_Translucent2.hlsl"

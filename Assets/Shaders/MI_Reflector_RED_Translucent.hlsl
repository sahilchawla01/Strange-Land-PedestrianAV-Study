...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[3] = float4(0.500000,0.000000,0.000000,1.000000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(0.500000,0.000000,0.000000,0.700000);//(Unknown)
	Material.PreshaderBuffer[5] = float4(0.400000,0.445234,0.100000,-1.000000);//(Unknown)
	Material.PreshaderBuffer[6] = float4(2.000000,1.000000,1.000000,2.000000);//(Unknown)
	Material.PreshaderBuffer[7] = float4(0.110000,0.090000,0.000000,70.000000);//(Unknown)
	Material.PreshaderBuffer[8] = float4(0.450000,0.000000,0.000000,0.000000);//(Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local7 = lerp(MaterialFloat3(0.00000000,0.00000000,0.00000000),Material.PreshaderBuffer[2].xyz,Material.PreshaderBuffer[1].z);
	...
	MaterialFloat Local13 = PositiveClampedPow(Local12,Material.PreshaderBuffer[5].z);
	MaterialFloat Local14 = (Local13 * Material.PreshaderBuffer[6].x);
	MaterialFloat Local15 = (Local14 + Material.PreshaderBuffer[5].w);
	MaterialFloat Local16 = (Material.PreshaderBuffer[6].y * Local15);
	MaterialFloat2 Local17 = (((MaterialFloat2)Material.PreshaderBuffer[6].w) * DERIV_BASE_VALUE(Local0));
	MaterialFloat Local18 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local17), 5);
	MaterialFloat4 Local19 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_1,samplerMaterial_Texture2D_1,DERIV_BASE_VALUE(Local17),View.MaterialTextureMipBias));
	MaterialFloat Local20 = MaterialStoreTexSample(Parameters, Local19, 5);
	MaterialFloat Local21 = lerp(Material.PreshaderBuffer[7].y,Material.PreshaderBuffer[7].x,Local19.r);

	PixelMaterialInputs.EmissiveColor = Local7;
	PixelMaterialInputs.Opacity = Local16;
	PixelMaterialInputs.OpacityMask = 1.00000000;
	PixelMaterialInputs.BaseColor = Material.PreshaderBuffer[4].xyz;
	PixelMaterialInputs.Metallic = Material.PreshaderBuffer[4].w;
	PixelMaterialInputs.Specular = Material.PreshaderBuffer[5].x;
	PixelMaterialInputs.Roughness = Material.PreshaderBuffer[5].y;
	PixelMaterialInputs.Anisotropy = 0.00000000;
	PixelMaterialInputs.Normal = Local6;
	PixelMaterialInputs.Tangent = Parameters.TangentToWorld[0];
	PixelMaterialInputs.Subsurface = 0;
	PixelMaterialInputs.AmbientOcclusion = 1.00000000;
	PixelMaterialInputs.Refraction = MaterialFloat3(MaterialFloat3(1.00000000,0.00000000,0.00000000).xy,Material.PreshaderBuffer[7].z);

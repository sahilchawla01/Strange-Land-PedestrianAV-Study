Shader "Unreal/EmissiveTexturedMaterial(cornerStoreTexturedGeos_blinn7_Didnt_Compile_25_40989)"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        #include "EmissiveTexturedMaterial(cornerStoreTexturedGeos_blinn7_Didnt_Compile_25_40989).hlsl"

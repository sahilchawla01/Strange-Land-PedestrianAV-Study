Shader "Unreal/EmissiveTexturedMaterial(aptivCar_geo_interior_plastic_5_Didnt_Compile_33_40970)"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        #include "EmissiveTexturedMaterial(aptivCar_geo_interior_plastic_5_Didnt_Compile_33_40970).hlsl"

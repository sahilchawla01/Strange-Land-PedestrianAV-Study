...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[2] = float4(0.776000,0.776000,0.776000,0.000000);//(Unknown)
	Material.PreshaderBuffer[3] = float4(0.776000,0.776000,0.776000,0.000000);//(Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	PixelMaterialInputs.Opacity = MaterialFloat3(0.00000000,0.00000000,0.00000000).r;

...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[11] = float4(0.600000,-0.250000,1.000000,593.460022);//(Unknown)
	Material.PreshaderBuffer[12] = float4(-593.460022,1.000000,593.460022,0.000000);//(Unknown)
	Material.PreshaderBuffer[13] = float4(0.000000,0.000000,593.460022,0.000000);//(Unknown)

Shader "Unreal/EmissiveTexturedMaterial(MI_MapleTree_branch_G_Didnt_Compile_21_41134)"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        #include "EmissiveTexturedMaterial(MI_MapleTree_branch_G_Didnt_Compile_21_41134).hlsl"

...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[5] = float4(0.092773,0.137369,0.468750,1.000000);//(Unknown)
	Material.PreshaderBuffer[6] = float4(0.567339,0.826946,2.000000,2.000000);//(Unknown)
	Material.PreshaderBuffer[7] = float4(64.000000,0.567339,0.826946,2.000000);//(Unknown)
	...
	Material.PreshaderBuffer[13] = float4(286.265015,218.167999,0.000000,1.599844);//(Unknown)
	...
	Material.PreshaderBuffer[17] = float4(0.092773,0.137369,0.468750,0.875000);//(Unknown)
	Material.PreshaderBuffer[18] = float4(3.000000,0.189442,0.768319,0.000000);//(Unknown)

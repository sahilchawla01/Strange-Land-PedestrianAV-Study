Shader "Unreal/cornerStoreTexturedGeos_blinn74"
{
    Properties
    {
		...
		Material_Texture2D_0( "Fire_Hydrant_N", 2D ) = "white" {}
		Material_Texture2D_1( "Fire_Hydrant_D", 2D ) = "white" {}
		Material_Texture2D_2( "Fire_Hydrant_S", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "cornerStoreTexturedGeos_blinn74.hlsl"

Shader "Unreal/EmissiveTexturedMaterial(cornerStoreTexturedGeos_blinn53_Didnt_Compile_23_40995)"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        #include "EmissiveTexturedMaterial(cornerStoreTexturedGeos_blinn53_Didnt_Compile_23_40995).hlsl"

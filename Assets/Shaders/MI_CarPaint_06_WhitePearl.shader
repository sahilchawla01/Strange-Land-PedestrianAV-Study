Shader "Unreal/MI_CarPaint_06_WhitePearl"
{
    Properties
    {
		...
		Material_Texture2D_0( "Orange Peel Normal", 2D ) = "white" {}
		Material_Texture2D_1( "RandomAngles", 2D ) = "white" {}
		Material_Texture2D_2( "T_FlakeMask", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_CarPaint_06_WhitePearl.hlsl"

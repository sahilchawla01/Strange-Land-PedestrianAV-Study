Shader "Unreal/EmissiveTexturedMaterial(cornerStoreTexturedGeos_blinn73_Didnt_Compile_27_40983)"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        #include "EmissiveTexturedMaterial(cornerStoreTexturedGeos_blinn73_Didnt_Compile_27_40983).hlsl"

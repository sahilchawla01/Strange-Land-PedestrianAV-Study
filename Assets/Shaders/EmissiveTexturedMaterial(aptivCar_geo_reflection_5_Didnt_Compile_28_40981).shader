Shader "Unreal/EmissiveTexturedMaterial(aptivCar_geo_reflection_5_Didnt_Compile_28_40981)"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        #include "EmissiveTexturedMaterial(aptivCar_geo_reflection_5_Didnt_Compile_28_40981).hlsl"

...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[5] = float4(0.400000,0.445234,1.000000,2.000000);//(Unknown)
	Material.PreshaderBuffer[6] = float4(0.110000,0.090000,40.000000,0.450000);//(Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat2 Local8 = (((MaterialFloat2)Material.PreshaderBuffer[5].w) * DERIV_BASE_VALUE(Local0));
	...
	MaterialFloat Local12 = lerp(Material.PreshaderBuffer[6].y,Material.PreshaderBuffer[6].x,Local10.r);

Shader "Unreal/Soho_stage01_sb_door01"
{
    Properties
    {
		...
		Material_Texture2D_0( "doors_bmp01", 2D ) = "white" {}
		Material_Texture2D_1( "doors_clr01", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "Soho_stage01_sb_door01.hlsl"

Shader "Unreal/MI_Speedmeter"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_blank_N", 2D ) = "white" {}
		Material_Texture2D_1( "emissive", 2D ) = "white" {}
		Material_Texture2D_2( "em_mask", 2D ) = "white" {}
		Material_Texture2D_3( "difuse", 2D ) = "white" {}

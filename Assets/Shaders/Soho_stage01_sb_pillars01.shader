Shader "Unreal/Soho_stage01_sb_pillars01"
{
    Properties
    {
		...
		Material_Texture2D_0( "pillars_bmp01", 2D ) = "white" {}
		Material_Texture2D_1( "pillars_clr01", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "Soho_stage01_sb_pillars01.hlsl"

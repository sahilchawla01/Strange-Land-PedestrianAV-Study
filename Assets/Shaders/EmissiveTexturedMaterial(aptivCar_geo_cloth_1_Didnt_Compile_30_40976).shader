Shader "Unreal/EmissiveTexturedMaterial(aptivCar_geo_cloth_1_Didnt_Compile_30_40976)"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        #include "EmissiveTexturedMaterial(aptivCar_geo_cloth_1_Didnt_Compile_30_40976).hlsl"
